...
const pintarCard = pokemon => {
    ...
    clone.querySelectorAll('.card-footer-stats h3')[0].textContent = pokemon.ataque
    clone.querySelectorAll('.card-footer-stats h3')[1].textContent = pokemon.especial
    clone.querySelectorAll('.card-footer-stats h3')[2].textContent = pokemon.defensa
